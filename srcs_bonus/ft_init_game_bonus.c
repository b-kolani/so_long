...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/01/05 14:03:51 by bkolani           #+#    #+#             */
/*   Updated: 2025/01/05 21:10:45 by bkolani          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_init_sprites(t_game *game)
{
	...
	game->enemy_right = ft_new_sprite(mlx, ENEMY_RIGHT_XPM, game);
	game->enemy_left = ft_new_sprite(mlx, ENEMY_LEFT_XPM, game);
